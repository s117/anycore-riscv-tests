...
403.gcc_test: 				;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m2048 $(SPIKE_ARGS) pk -c ./gcc_base.riscv cccp.i -o cccp.s 2>&1 | tee run.log
...
400.perlbench_checkspam_ref:	;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m2048 $(SPIKE_ARGS) pk -c ./perlbench_base.riscv -I./lib checkspam.pl 2500 5 25 11 150 1 1 1 1  2>&1 | tee run.log
400.perlbench_diffmail_ref:		;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m2048 $(SPIKE_ARGS) pk -c ./perlbench_base.riscv -I./lib diffmail.pl 4 800 10 17 19 300  2>&1 | tee run.log
400.perlbench_splitmail_ref:	;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m2048 $(SPIKE_ARGS) pk -c ./perlbench_base.riscv -I./lib splitmail.pl 1600 12 26 16 4500  2>&1 | tee run.log
...
403.gcc_ref: 									;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m2048 $(SPIKE_ARGS) pk -c ./gcc_base.riscv expr.in -o expr.s 2>&1 | tee run.log
...
473.astar_biglakes_ref: 			;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m2048 $(SPIKE_ARGS) pk -c ./astar_base.riscv BigLakes2048.cfg 2>&1 | tee run.log
473.astar_rivers_ref: 				;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m2048 $(SPIKE_ARGS) pk -c ./astar_base.riscv rivers.cfg 2>&1 | tee run.log
...
436.cactusADM_ref:	;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m2048 $(SPIKE_ARGS) pk -c ./cactusADM_base.riscv benchADM.par 2>&1 | tee run.log
...
459.GemsFDTD_ref:     	;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m2048 $(SPIKE_ARGS) pk -c ./GemsFDTD_base.riscv 2>&1 | tee run.log
...
482.sphinx3_ref: 		;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m16384 $(SPIKE_ARGS) pk -c ./sphinx_livepretend_base.riscv ctlfile . args.an4 2>&1 | tee run.log
...
648.exchange2_s_test:				;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m4096 $(SPIKE_ARGS) pk -c exchange2_s_base.riscv-m64 0 2>&1 | tee run.log
...
600.perlbench_s_spam_ref:		;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m8192 $(SPIKE_ARGS) pk -c perlbench_s_base.riscv-m64 -I./lib checkspam.pl 2500 5 25 11 150 1 1 1 1 2>&1 | tee run.log
600.perlbench_s_diff_ref:		;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m8192 $(SPIKE_ARGS) pk -c perlbench_s_base.riscv-m64 -I./lib diffmail.pl 4 800 10 17 19 300 2>&1 | tee run.log
...
# These run into SYSCALL #96 or other which is not supported by pk
602.gcc_s_1_ref:     				;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m8192 $(SPIKE_ARGS) pk -c sgcc_base.riscv-m64 gcc-pp.c -O5 -fipa-pta -o gcc-pp.opts-O5_-fipa-pta.s 2>&1 | tee run.log
602.gcc_s_2_ref:     				;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m8192 $(SPIKE_ARGS) pk -c sgcc_base.riscv-m64 gcc-pp.c -O5 -finline-limit=1000 -fselective-scheduling -fselective-scheduling2 -o gcc-pp.opts-O5_-finline-limit_1000_-fselective-scheduling_-fselective-scheduling2.s 2>&1 | tee run.log
602.gcc_s_3_ref:     				;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m8192 $(SPIKE_ARGS) pk -c sgcc_base.riscv-m64 gcc-pp.c -O5 -finline-limit=24000 -fgcse -fgcse-las -fgcse-lm -fgcse-sm -o gcc-pp.opts-O5_-finline-limit_24000_-fgcse_-fgcse-las_-fgcse-lm_-fgcse-sm.s 2>&1 | tee run.log
620.omnetpp_s_ref:  				;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m8192 $(SPIKE_ARGS) pk -c omnetpp_s_base.riscv-m64 -c General -r 0 2>&1 | tee run.log
631.deepsjeng_s_ref:				;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m16384 $(SPIKE_ARGS) pk -c deepsjeng_s_base.riscv-m64 ref.txt 2>&1 | tee run.log
657.xz_s_docs_ref:    			;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m16384 $(SPIKE_ARGS) pk -c xz_s_base.riscv-m64 cpu2006docs.tar.xz 6643 055ce243071129412e9dd0b3b69a21654033a9b723d874b2015c774fac1553d9713be561ca86f74e4f16f22e664fc17a79f30caa5ad2c04fbc447549c2810fae 1036078272 1111795472 4 2>&1 | tee run.log
657.xz_s_cld_ref:    				;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m16384 $(SPIKE_ARGS) pk -c xz_s_base.riscv-m64 cld.tar.xz 1400 19cf30ae51eddcbefda78dd06014b4b96281456e078ca7c13e1c0c9e6aaea8dff3efb4ad6b0456697718cede6bd5454852652806a657bb56e07d61128434b474 536995164 539938872 8 2>&1 | tee run.log

## FP SPEED

# These run into SYSCALL #96 or other which is not supported by pk
603.bwaves_s_1_ref:  				;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m16384 $(SPIKE_ARGS) pk -c speed_bwaves_base.riscv-m64 bwaves_1 < bwaves_1.in 2>&1 | tee run.log
603.bwaves_s_2_ref:  				;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m16384 $(SPIKE_ARGS) pk -c speed_bwaves_base.riscv-m64 bwaves_2 < bwaves_2.in 2>&1 | tee run.log
607.cactuBSSN_s_ref:				;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m16384 $(SPIKE_ARGS) pk -c cactuBSSN_s_base.riscv-m64 spec_ref.par 2>&1 | tee run.log
619.lbm_s_ref:      				;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m8192 $(SPIKE_ARGS) pk -c lbm_s_base.riscv-m64 2000 reference.dat 0 0 200_200_260_ldc.of 2>&1 | tee run.log
621.wrf_s_ref:      				;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m16384 $(SPIKE_ARGS) pk -c wrf_s_base.riscv-m64 2>&1 | tee run.log
627.cam4_s_ref:     				;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike -m8192 $(SPIKE_ARGS) pk -c cam4_s_base.riscv-m64 2>&1 | tee run.log
628.pop2_s_ref:     				;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m16384 $(SPIKE_ARGS) pk -c speed_pop2_base.riscv-m64 2>&1 | tee run.log
...
644.nab_s_ref:      				;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m16384 $(SPIKE_ARGS) pk -c nab_s_base.riscv-m64 3j1n 20140317 220 2>&1 | tee run.log
649.fotonik3d_s_ref:				;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m16384 $(SPIKE_ARGS) pk -c fotonik3d_s_base.riscv-m64 2>&1 | tee run.log
654.roms_s_ref:     				;-nice -19 $(RISCV_INSTALL_DIR)/bin/spike	-m16384 $(SPIKE_ARGS) pk -c sroms_base.riscv-m64 < ocean_benchmark3.in 2>&1 | tee run.log
