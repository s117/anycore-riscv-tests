...
# The set of benchmark that will be supported in each task
all_smpt_bmarks =	\
					$(all_spec_bmarks) \
...
# The set of benchmark that will be run in each task
run_smpt_bmarks = \
					$(all_smpt_bmarks) \
...
smpt_spec_2k6_ref_bmarks =	\
				$(SPEC_BIN_DIR)/400.perlbench_ref+400.perlbench_checkspam_ref \
				$(SPEC_BIN_DIR)/400.perlbench_ref+400.perlbench_diffmail_ref \
				$(SPEC_BIN_DIR)/400.perlbench_ref+400.perlbench_splitmail_ref \
				...
				$(SPEC_BIN_DIR)/473.astar_ref+473.astar_biglakes_ref \
				$(SPEC_BIN_DIR)/473.astar_ref+473.astar_rivers_ref \
